...
export const ActiveTimeInsight: React.FC<ActiveTimeInsightProps> = ({ data }) => {
  return (
    <div className="w-full flex flex-col items-center gap-6 text-center animate-fade-in">
      <div className="bg-blue-500/10 p-6 rounded-full relative overflow-hidden glass-effect">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-blue-500/20 rounded-full animate-pulse-slow"></div>
        <Clock className="h-12 w-12 text-blue-500 relative z-10" />
      </div>
      ...
      <div className="w-full max-w-sm mt-4 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 h-24 rounded-lg relative overflow-hidden glass-effect">
