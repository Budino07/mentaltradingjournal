...
import { Home, BookOpen, BarChart2, Settings, UserCog, FlaskConical, BrainCircuit, Notebook, LineChart, List, Activity } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Mental Wrapped", icon: Activity, url: "/mental-wrapped" },
