    ...
    <div className="space-y-4">
      <div className="flex items-center gap-2 md:gap-4">
        <div className="flex items-center gap-2">
          <h2 className={`${isMobile ? 'text-2xl' : 'text-3xl'} font-bold bg-gradient-to-r from-primary-light to-accent bg-clip-text text-transparent`}>
          ...
          {sessionType === "pre" && (
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className={`max-w-[300px] p-4 ${isMobile ? 'text-sm' : ''}`}>
